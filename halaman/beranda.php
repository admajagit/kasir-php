<!-- Search & Tambah -->
<div class="d-flex flex-wrap justify-content-between form-container">
    <nav class="navbar">
        <form action="index.php" method="GET" class="form-inline">
            <input class="form-control" type="search" autocomplete="off" name="key-search" placeholder="Cari..">
